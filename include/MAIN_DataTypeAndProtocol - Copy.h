...
#endif
#else              // original
#define MAX_USER_ID_LENGTH											101
#endif
#ifdef __SINA__
#define MAX_USER_PASSWORD_LENGTH									1024
#else 
#define MAX_USER_PASSWORD_LENGTH									101
#endif
...
typedef struct
{
	...
	int iCheckLowItem;
	int iCheckExchange;
	int iSetBonus; // TS 2.5
	int iSetBonus2; // TS 2.5
	int iStrength;
	int iWisdom;
	int iVitality;
	int iKi;
...
typedef struct
{
	...
	int nSize[3];
	int nMenu[100]; //Twelvesky2 [50] - Twelvesky2.5 [100]
	int nShopInfo[3][28];
	int nSkillInfo1[3][8];
...
#define S_LOGIN_RECV												32 + MAX_USER_ID_LENGTH + MAX_MOUSE_PASSWORD_LENGTH + 200
