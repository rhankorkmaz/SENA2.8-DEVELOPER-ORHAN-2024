...
public:
	...
	void GL_BUY_SHOP_ITEM(int tUserIndex, int tOtherUserIndex, int iIndex, char UseItemId[25], int tValue, int soket1, int soket2, int soket3, int soket4, int soket5, int tCost);
	...
	void GL_BUY_VALET_ITEM(int tUserIndex, int tOtherUserIndex, int iIndex, char UseItemId[25], int tValue, int soket1, int soket2, int soket3, int soket4, int soket5, int tCost);
	...
	void GL_615_TRADE_ITEM(int tUserIndex, int tOtherIndex, int ItemId, const char* ItemName, int iValue, int iQuantity, int Soket1, int Soket2, int Soket3, int Soket4, int Soket5);
